			...
			<div class='row'>
				...
				<div class='col-sm-4'>
					<ul align='right'>";
						...
						echo "
						<li><a href='' data-toggle='modal' data-target='#exampleModal'><i class='fas fa-sign-in-alt'></i></a></li>";
						}
					echo "
					</ul>
				</div>
		...
		public function menu_adm(){
			echo "<ul>
					...
					echo "<li class='chatboxa'><a><i class='fas fa-comments'></i> ChatBox</a>
						<ul>
							<li><a href='admin/c-chatbox'><i class='fas fa-cog'></i> Configurações</a></li>
						</ul>
					</li>
